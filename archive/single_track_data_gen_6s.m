...
m_Vehicle_kSteering = 32;%30.0811;
...
next_state(13, 1) = wF - deltaT * m_Vehicle_rF / m_Vehicle_IwF * fFx;
next_state(14, 1) = wF - deltaT * m_Vehicle_rF / m_Vehicle_IwF * fFx;
next_state(15, 1) = wR + deltaT * (m_Vehicle_kTorque * (T-wR) - m_Vehicle_rR * fRx) / m_Vehicle_IwR;
next_state(16, 1) = wR + deltaT * (m_Vehicle_kTorque * (T-wR) - m_Vehicle_rR * fRx) / m_Vehicle_IwR;
next_state(4, 1) = X + deltaT * dot_X;
next_state(5, 1) = Y + deltaT * dot_Y;
next_state(6, 1) = psi + deltaT * wz;

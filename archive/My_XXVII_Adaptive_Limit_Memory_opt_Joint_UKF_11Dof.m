function [ para_opt, J, X_train, Y_opt, Y_train ] = My_XXVII_Adaptive_Limit_Memory_opt_Joint_UKF_11Dof (XI, YI, YawAngle2, Vx, Vy, r, RollAngle, PitchAngle, steering, steering2, w_lf, w_lr, w_rf, w_rr, dt)
...
Area=1.8/25; %(reference area =0.138)
...
para0 = [  0.779,    0.25,         0.1,       7.79817410543529,       1.6,    1, -0.526797954883659,  -0.0514327220075633,  -0.0454297657839960,       14,        0.466447502050303,       0.503,        0.306,          2500,            2500,                210            210];
%          Iz         lf            h                  B               C      D       E                    Sh                 Sv                     scl              Cd                  Ix               Iy              Kf       Kr       Cf       Cr 
para_lb=[  0.1       0.01        0.01              1               0      0.4      -1                 -0.2               -0.1                     10             0.01                  0.05            0.03              1000    1000     500      500   ];   %lower boundry
para_ub=[  10       0.56        0.56               10               4      1.05     1                   0.2                0.1                     20             0.5                   5               3                40000    50000     4000     4000  ];   %upper boundry
